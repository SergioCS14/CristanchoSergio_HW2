...
plt.figure()
plt.title("Trayectoria con fricción $\gamma =100$, backwards difference")
...
plt.figure()
plt.title("Trayectoria con fricción $\gamma =100$, velocidad anterior")
...
Piso1b2t = np.genfromtxt('3_Piso1_bono2.dat',delimiter=',')
Piso1b2 = np.transpose(Piso1b2t)
Piso2b2t = np.genfromtxt('3_Piso2_bono2.dat',delimiter=',')
Piso2b2 = np.transpose(Piso2b2t)
Piso3b2t = np.genfromtxt('3_Piso3_bono2.dat',delimiter=',')
Piso3b2 = np.transpose(Piso3b2t)

plt.figure()
plt.title("Trayectoria con fricción $\gamma =100$, aprox. lineal")
plt.plot(Piso1b2[0],Piso1b2[1], label='Piso 1')
plt.plot(Piso2b2[0],Piso2b2[1], label='Piso 2')
plt.plot(Piso3b2[0],Piso3b2[1], label='Piso 3')
plt.legend()
plt.xlabel('$t$')
plt.ylabel('$u(t)$')
plt.savefig('3_Edificio_bono2.pdf')
